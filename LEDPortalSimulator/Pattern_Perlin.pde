...
@LXCategory("Color")
public class Simplex extends LXPattern {
...
// TODO: convert these to parameters
	...
	public final EnumParameter palette =
	 new EnumParameter("ColorPallete", ePalette.Rainbow )
	 .setDescription("ColorPallete");

	public final CompoundParameter spaceScale = new CompoundParameter("Space Scape", 0.1, 0.0, 1.0)
	 .setDescription("The size of the lumps");
